...
TEST_CASE( endsWithSomeTest, StrutilTests ) {
...
TEST_CASE( isEqualToSomeTest, StrutilTests ) {
...
TEST_CASE( isNextSubstrTest, StrutilTests ) {
...
TEST_CASE( replaceTest, StrutilTests ) {
...
TEST_CASE( replaceAllTest, StrutilTests ) {
...
TEST_CASE( isWhiteSpaceTest, StrutilTests ) {
...
TEST_CASE( removeStartWithSpacesTest, StrutilTests ) {
...
TEST_CASE( splitWithDoubleQuotesTest, StrutilTests ) {
    string str1 = "   a b c  ";
...
namespace strutiltests {
    ...
    void addTestCases() {
        ADD_TEST_CASE( startsWithTest, StrutilTests );
        ADD_TEST_CASE( endsWithTest, StrutilTests );
        ADD_TEST_CASE( endsWithSomeTest, StrutilTests );
        ADD_TEST_CASE( isEqualToSomeTest, StrutilTests );
        ADD_TEST_CASE( isNextSubstrTest, StrutilTests );
        ADD_TEST_CASE( trimTests, StrutilTests );
        ADD_TEST_CASE( replaceTest, StrutilTests );
        ADD_TEST_CASE( replaceAllTest, StrutilTests );
        ADD_TEST_CASE( isWhiteSpaceTest, StrutilTests );
        ADD_TEST_CASE( removeStartWithSpacesTest, StrutilTests );
        ADD_TEST_CASE( splitWithDoubleQuotesTest, StrutilTests );
    }
